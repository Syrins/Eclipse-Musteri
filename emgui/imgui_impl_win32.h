...
MsTrG_IMPL_API bool     MsTrG_ImplWin32_Init(void* hwnd);
MsTrG_IMPL_API void     MsTrG_ImplWin32_Shutdown();
MsTrG_IMPL_API void     MsTrG_ImplWin32_NewFrame();
...
MsTrG_IMPL_API void     MsTrG_ImplWin32_EnableDpiAwareness();
MsTrG_IMPL_API float    MsTrG_ImplWin32_GetDpiScaleForHwnd(void* hwnd);       // HWND hwnd
MsTrG_IMPL_API float    MsTrG_ImplWin32_GetDpiScaleForMonitor(void* monitor); // HMONITOR monitor

// Transparency related helpers (optional) [experimental]
// - Use to enable alpha compositing transparency with the desktop.
// - Use together with e.g. clearing your framebuffer with zero-alpha.
MsTrG_IMPL_API void     MsTrG_ImplWin32_EnableAlphaCompositing(void* hwnd);   // HWND hwnd
